...
{
    internal class LosslessScalingCaptureApiProperty : WidgetControlProperty<string, ComboBox>
    {
        public LosslessScalingCaptureApiProperty(ComboBox inUI, Page inOwner)
            : base("WGC", Function.LosslessScalingCaptureApi, inUI, inOwner)
        {
            if (UI != null)
            {
                ...
                // equals this constructor default.
