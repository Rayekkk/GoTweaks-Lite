...
{
    internal class LosslessScalingScaleModeProperty : WidgetControlProperty<string, ComboBox>
    {
        public LosslessScalingScaleModeProperty(ComboBox inUI, Page inOwner) : base("Auto", Function.LosslessScalingScaleMode, inUI, inOwner)
        {
            if (UI != null)
            {
                ...
                // equals this constructor default, which it does for the common "Auto" case.
