...
{
    internal class LosslessScalingLSFG3ModeProperty : WidgetControlProperty<string, ComboBox>
    {
        public LosslessScalingLSFG3ModeProperty(ComboBox inUI, Page inOwner) : base("FIXED", Function.LosslessScalingLSFG3Mode, inUI, inOwner)
        {
            if (UI != null)
            {
                ...
                // equals this constructor default, which it does for the common "FIXED" case.
