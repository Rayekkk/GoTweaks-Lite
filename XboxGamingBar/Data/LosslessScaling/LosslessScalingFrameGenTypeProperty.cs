...
{
    internal class LosslessScalingFrameGenTypeProperty : WidgetControlProperty<string, ComboBox>
    {
        public LosslessScalingFrameGenTypeProperty(ComboBox inUI, Page inOwner) : base("Off", Function.LosslessScalingFrameGenType, inUI, inOwner)
        {
            if (UI != null)
            {
                ...
                // equals this constructor default, which it does for the common "Off" case.
