...
{
    internal class LosslessScalingLSFG2ModeProperty : WidgetControlProperty<string, ComboBox>
    {
        public LosslessScalingLSFG2ModeProperty(ComboBox inUI, Page inOwner) : base("X2", Function.LosslessScalingLSFG2Mode, inUI, inOwner)
        {
            if (UI != null)
            {
                ...
                // equals this constructor default, which it does for the common "X2" case.
