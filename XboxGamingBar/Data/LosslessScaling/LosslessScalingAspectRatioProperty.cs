...
{
    internal class LosslessScalingAspectRatioProperty : WidgetControlProperty<string, ComboBox>
    {
        public LosslessScalingAspectRatioProperty(ComboBox inUI, Page inOwner) : base("Aspect Ratio", Function.LosslessScalingAspectRatio, inUI, inOwner)
        {
            if (UI != null)
            {
                ...
                // equals this constructor default, which it does for the common "Aspect Ratio" case.
