...
public class IADLXDisplayColorDepth : IADLXInterface {
  ...
  public virtual ADLX_RESULT GetValue(SWIGTYPE_p_adlx__ADLX_COLOR_DEPTH currentColorDepth) {
    ADLX_RESULT ret = (ADLX_RESULT)ADLXPINVOKE.IADLXDisplayColorDepth_GetValue(swigCPtr, SWIGTYPE_p_adlx__ADLX_COLOR_DEPTH.getCPtr(currentColorDepth));
    return ret;
  }
